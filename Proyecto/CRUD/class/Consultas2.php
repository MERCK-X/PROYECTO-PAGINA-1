...
class Usuarios
{
    ...
    {
        try {
            $query = $this->dbh->prepare("SELECT * FROM administradores WHERE usuario LIKE ? and correo LIKE ? and contraseña LIKE ?");
    ...
    {
        try {
            $query = $this->dbh->prepare("INSERT INTO administradores VALUES (null,?,?,?,?)");
